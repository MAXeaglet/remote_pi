...
describe("ipcAddress", () => {
  test("POSIX → returns the filesystem path unchanged", () => {
    const p = "/home/u/.omp/remote/supervisor.sock";
